...
1. The back-end service sends a gRPC request (create, update, status change, or delete) when user/project data changes.
...
4. The recommendation service can then query these collections to find semantically similar users or projects.
